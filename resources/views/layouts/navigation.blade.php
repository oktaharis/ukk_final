            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif (Auth::user()->role === 'employee')
                        ...
                        <x-nav-link :href="route('employee.sales.index')" :active="request()->routeIs('employee.sales.index')">
                            {{ __('Penjualan') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif (Auth::user()->role === 'employee')
                ...
                <x-responsive-nav-link :href="route('employee.products.index')" :active="request()->routeIs('employee.products.index')">
                    {{ __('Produk') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('employee.sales.index')" :active="request()->routeIs('employee.sales.index')">
                    {{ __('Penjualan') }}
                </x-responsive-nav-link>
            @endif
        </div>
