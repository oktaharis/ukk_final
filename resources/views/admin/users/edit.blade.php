...
<div class="container px-4 mx-auto">
    <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="max-w-2xl mx-auto">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ $user->name }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-blue-500" required>
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Password (Biarkan kosong jika tidak ingin mengubah)</label>
            ...
            <div>
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="w-full px-4 py-2 border border-gray-300 rounded-lg dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-blue-500">
            </div>
        </div>
            ...
            >
                ...
                <div class="space-y-2 text-center">
                    ...
                    <div id="image-preview" class="w-24 h-24 mx-auto overflow-hidden border-2 border-white rounded-full shadow-lg">
                        @if ($user->avatar)
                            <img src="{{ asset('storage/' . $user->avatar) }}" alt="Avatar" class="object-cover w-full h-full">
                        @else
